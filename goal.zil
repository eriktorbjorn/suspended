...
<ROUTINE SET-GOAL (RBT GOAL "AUX" (HERE <LOC .RBT>) GT)
	 #DECL ((RBT GOAL HERE) OBJECT
...
<ROUTINE FOLLOW-GOAL (RBT "AUX" (HERE <LOC .RBT>) LINE RM GT GOAL FLG
				   (GOAL-FLAG <>) (IGOAL <>) LOC (CNT 1))
	 #DECL ((RBT HERE LOC RM) OBJECT (CNT) FIX
...
<ROUTINE G-ROBOT (RBT GARG "AUX" TEMP CHASED)
	 <COND (<==? .GARG ,G-REACHED>
		<SET TEMP ,WINNER>
		<CHANGE-WINNER .RBT T>
		<CRLF>
